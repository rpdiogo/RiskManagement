  ...
  return (
    <div className="space-y-5">
      <div className="grid grid-cols-6 gap-4">
        <KpiCard title="Riscos Totais"   value={d.totalRisks}    trend={d.trends?.total}    inverse icon={<Shield size={20} className="text-blue-600" />}         iconBg="bg-blue-50" />
        <KpiCard title="Riscos Críticos" value={d.criticalRisks} trend={d.trends?.critical} inverse icon={<AlertTriangle size={20} className="text-red-500" />}    iconBg="bg-red-50" />
        <KpiCard title="Riscos Altos"    value={d.highRisks}     trend={d.trends?.high}     inverse icon={<ShieldAlert size={20} className="text-orange-500" />}   iconBg="bg-orange-50" />
        <KpiCard title="Riscos Médios"   value={d.mediumRisks}   trend={d.trends?.medium}   inverse icon={<AlertCircle size={20} className="text-yellow-500" />}   iconBg="bg-yellow-50" />
        <KpiCard title="Riscos Baixos"   value={d.lowRisks}      trend={d.trends?.low}             icon={<CheckCircle size={20} className="text-green-500" />}    iconBg="bg-green-50" />
