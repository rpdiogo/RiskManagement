...
RISKS = [
    ...
    dict(
        ...
        owner="CISO", status="in_treatment", trend="up",
    ),
    dict(
        ...
        owner="CISO", status="in_treatment", trend="stable",
    ),
    dict(
    ...
    dict(
        ...
        owner="CISO / Compliance", status="in_treatment", trend="stable",
    ),
    dict(
...
ACTION_PLANS = [
    ...
    dict(id="A003", risk_id="R003", title="Contratação de cyber insurance policy",                                           owner="Direção / CISO",      due_date="2026-09-30", status="not_started"),
    ...
    dict(id="A006", risk_id="R006", title="Implementar simulações de phishing trimestrais com formação personalizada",       owner="CISO / RH",           due_date="2026-12-31", status="in_progress"),
    dict(id="A007", risk_id="R007", title="Implementar processo formal de Third-Party Risk Management (TPRM)",               owner="Compras / CISO",      due_date="2026-12-31", status="not_started"),
    ...
    dict(id="A009", risk_id="R009", title="Aprovar política de cibersegurança formal pela Direção",                         owner="CISO / Direção",      due_date="2026-06-30", status="in_progress"),
